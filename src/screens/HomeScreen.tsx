...
import GlobalSearchComponent from "../components/GlobalSearchComponent/GlobalSearchComponent";
import GlobalIconComponent from "../components/GlobalIconComponent/GlobalIconComponent";
...
const HomeScreen = () => {
  ...
  const loadData = () => {
    return new Promise((resolve, reject) => {
      setTimeout(resolve, 2000); // Resolve after 2 seconds
    });
  };
  return (
    <ImageBackground
      ...
      resizeMode="cover"
    >
      <SafeAreaView style={[styles.screen, { zIndex: 0 }]}>
        <WelcomeModal />
        ...
        />
        <GlobalIconComponent
          icon={<FontAwesome name="send" size={18} />}
          onPress={loadData}
        />
        <GlobalIconComponent
          icon={<FontAwesome name="send" size={18} />}
        ...
        <GlobalIconComponent
          ...
          iconColor="red"
        />
        <View style={[styles.searchAndIconContainer, { zIndex: -1 }]}>
          ...
          <Pressable
            ...
            style={styles.icon_usemylocation}
          >
